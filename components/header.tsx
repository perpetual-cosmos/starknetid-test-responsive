  ...
  return (
    <div className="flex justify-between py-6">
        ...
        <div className="mr-[4vw] flex gap-x-4">
            ...
            <div className="flex items-center bg-white p-2 shadow-sm rounded"><button className="mr-2">kevin.stark</button><Clock size={18} color="#000000" className="border-0"/></div>
        </div>
    </div>
  )
};
